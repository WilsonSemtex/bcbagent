...
LIMITED_KB_ADMIN_USERNAME = "administrator"
...
async def chat_with_file_stream(
    ...
    doc_exts = {".pdf", ".txt", ".docx", ".pptx", ".xlsx", ".xls", ".doc", ".ppt"}

    code_exts = {".py", ".js", ".html", ".css", ".json", ".md", ".csv"}
...
async def upload_document(file: UploadFile = File(...), agent_id: str = Form(None), username: str = Depends(require_auth)):
    ...
    allowed_ext = {".pdf", ".txt", ".md", ".docx", ".pptx", ".xlsx", ".xls", ".doc", ".ppt", ".png", ".jpg", ".jpeg", ".gif", ".bmp", ".webp"}
